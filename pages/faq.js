    ...
    const questions = [
        {
            ...
            answer: 'A.We specify on custom built mechanical keyboards such as Keychron, Ducky, Yunzii, Varmilo and more are to come.'
        },
        {
            question: 'Q.Can I return a keyboard if I am not satisfied with it?',
            answer: 'A.Yes, we offer a 30-day return policy for all of our products. Please contact our customer service team for more information.'
        },
        {
            question: 'Q.Can I customize the lighting on a mechanical keyboard?',
            answer: 'A.Many of our mechanical keyboards have customizable lighting options, allowing you to change the color and brightness of the backlit keys.'
        },
        {
            question: 'Q.Do you offer any warranties on your keyboards?',
            answer: 'A.Yes, we offer a one-year warranty on all of our keyboard products'
        },
        {
        ...
        },
        {
            ...
            answer: 'A.We offer various discounts throughout the year, please check our website regularly for current promotions.'
        },
    ]
      ...
      <div className={s.faqCon}>
       ...
       {questions.map((question, index) => (
            <div className={s.faqBox} key={index}>
                    ...
                    <div className={s.questionBox} onClick={() => setActiveQuestion(activeQuestion === index ? null : index)}>
                        {question.question} 
